...
public class Parser {
	...
	private void parseProgram() throws SyntaxError {
		...
		while (_currentToken.getTokenType() != TokenType.EOT) {
			System.out.println("The current token type is: " + _currentToken.getTokenType().toString());
			System.out.println("The current token text is: " + _currentToken.getTokenText());
			System.out.println("-------------------------------------------");
			_currentToken = this._scanner.scan();
		}
	}
